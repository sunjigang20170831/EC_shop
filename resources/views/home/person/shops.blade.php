@extends('home.person')
	...
	<div class="main-wrap">
					...
					<div class="am-cf am-padding">
						<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">商品发布</strong> / <small>Commodity&nbsp;Consultation</small></div>
					</div>
					<hr/>
					<div class="suggestmain">
						<p>商品分类：</p>
						<div class="suggestlist">
						<form action="{{ url('/home/shops') }}" method="post" enctype="multipart/form-data" name="form">
							{{ csrf_field() }}
							...
							<br/>
								<div class="suggestlist">
									商品名称：<input type="tel" id="user-IDcard" placeholder="请输入商品信息" name="shopname"></div>
									<div class="suggestlist">
									商品原价：<input type="tel" id="user-IDcard" placeholder="请输入商品原价" name="reprice"></div>
									<div class="suggestlist">
									商品现价：<input type="tel" id="user-IDcard" placeholder="请输入商品现价" name="price"></div>
