                    ...
                    @endif
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action='{{ url("admin/carousel")}}' method='post' enctype="multipart/form-data">
									{{ csrf_field() }}
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 图片名 </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="请输入图片名称" class="col-xs-10 col-sm-5" name='photoname'>
										</div>
