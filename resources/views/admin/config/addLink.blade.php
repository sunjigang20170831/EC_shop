							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action='{{ url("admin/link")}}' method='post'>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="请输入站点名称" class="col-xs-10 col-sm-5" name='name'>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="请输入跳转地址" class="col-xs-10 col-sm-5" name='address'>
										</div>
